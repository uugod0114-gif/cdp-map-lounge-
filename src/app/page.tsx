...
export default async function HomePage() {
  ...
  return (
    <PublicShell>
      ...
      {/* 교육 소개 */}
      <div id="intro" className="mx-auto max-w-4xl scroll-mt-24 px-4 py-16 sm:px-6">
        <BlockList blocks={aboutPage?.publishedBlocks ?? []} role="auditor" />
      </div>

      {/* 강의 일정 */}
      <div id="schedule" className="mx-auto max-w-4xl scroll-mt-24 px-4 py-16 sm:px-6">
      ...
      {/* 강의 자료 */}
      <div id="materials" className="mx-auto max-w-4xl scroll-mt-24 px-4 py-16 sm:px-6">
      ...
      {/* 실시간 피드백 */}
      <div id="feedback" className="mx-auto max-w-4xl scroll-mt-24 px-4 py-16 sm:px-6">
