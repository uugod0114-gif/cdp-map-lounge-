...
const ALL_LECTURES: { id: string; round: number; title: string; instructor: string }[] = [
  ...
  { id: "R2-2", round: 2, title: "처방명분 작성의 고찰", instructor: "김학준 실장님" },
  { id: "R2-3", round: 2, title: "AI 시대의 메디컬 Sales Forecast", instructor: "이영민님" },
  { id: "R2-4", round: 2, title: "Brand Planning : 목표 & 전략수립", instructor: "백정현 팀장님" },
  { id: "R2-5", round: 2, title: "MBO 및 성공모델 확산시스템의 이해", instructor: "오창헌 팀장님" },
  ...
  { id: "R3-2", round: 3, title: "신제품 발매 프로세스의 A to Z", instructor: "이상곤 팀장님" },
  { id: "R3-3", round: 3, title: "신제품 판촉자료 준비 프로세스", instructor: "윤지영님" },
  { id: "R3-4", round: 3, title: "시판 후 임상연구의 활용방안", instructor: "김소희님" },
  { id: "R3-5", round: 3, title: "유관부서 업무의 이해 (사업개발/신제품기획)", instructor: "임청하 센터장님" },
