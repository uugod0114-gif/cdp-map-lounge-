...
export const mockSessions: SessionRecord[] = [
  ...
  },
  {
    ...
    agenda: [
      { time: "08:30~09:00", minutes: "30'", title: "사전테스트", instructor: "진재훈" },
      { time: "09:00~09:30", minutes: "30'", title: "디지털 헬스케어 시장의 미래와 우리의 할일", instructor: "이대영" },
      ...
      { time: "13:40~15:10", minutes: "90'", title: "메일작성 Skill UP", instructor: "서동진" },
  ...
  },
  {
    ...
    visibilityRoles: [],
    agenda: [
      { time: "08:40~09:00", minutes: "20'", title: "오프닝", instructor: "조태훈" },
      { time: "09:00~12:30", minutes: "210'", title: "최종 전략 발표 및 평가", instructor: "사업부장/팀장" },
      { time: "12:30~13:30", minutes: "60'", title: "점심식사", instructor: "-" },
      { time: "13:30~14:20", minutes: "50'", title: "마케팅본부에서의 성장 경험", instructor: "김민성" },
      { time: "14:30~15:10", minutes: "40'", title: "마케팅본부에서의 거현량", instructor: "조병하" },
      { time: "15:10~15:50", minutes: "40'", title: "PM 토크콘서트", instructor: "박영준/멘토" },
      { time: "15:50~16:20", minutes: "30'", title: "클로징", instructor: "조태훈" },
    ],
    draftBlocks: [
...
export const mockMaterials: MaterialItem[] = [
  ...
  {
    id: nextId("mat"),
    title: "2회차 강의자료 다운로드 받기",
    description: "2회차 전체 강의 자료 모음",
    fileType: "pdf",
