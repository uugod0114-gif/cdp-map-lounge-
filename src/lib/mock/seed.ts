...
const aboutBlocks: ContentBlock[] = [
  ...
  block(
    "accordion",
    2,
    { title: "자주 헷갈리는 참여 유형", isActive: true, visibilityRoles: [] },
    {
      items: [
        {
          q: "수강자와 청강자는 뭐가 다른가요?",
...
const faqBlocks: ContentBlock[] = [
  ...
  block(
    ...
    {
      items: [
        { q: "수료 기준이 궁금해요.", a: "전체 세션 80% 이상 출석 및 과제 완료 시 수료됩니다." },
        { q: "청강자도 수료증을 받을 수 있나요?", a: "청강자는 참여 확인서가 발급됩니다." },
      ],
    },
  ),
];
...
export const mockMaterials: MaterialItem[] = [
  ...
  },
  {
    ...
    description: "1주차 오리엔테이션 발표 자료",
    fileType: "pdf",
    visibilityRoles: [],
    downloadAllowed: true,
    flipbookEnabled: true,
    fileUrl: "/files/orientation.pdf",
    coverImageUrl: "/images/cdp-map-poster.png",
  },
  {
    id: nextId("mat"),
    title: "브랜드 포지셔닝 워크북",
    description: "2주차 실습용 워크북",
    fileType: "pptx",
    visibilityRoles: ["learner", "auditor"],
    downloadAllowed: true,
    flipbookEnabled: false,
    fileUrl: "/files/positioning-workbook.pptx",
  },
];
